...
export default function SearchSelect({ options = [], value, onChange, placeholder }) {
    ...
    // Ensure options is always a valid array — cmdk crashes on null/undefined children
    ...
    return (
        <div className="relative">
            ...
            {open && safeOptions.length > 0 && createPortal(
                <div
                    className="fixed z-50 mt-1 bg-white border border-stone-200 rounded-xl shadow-md overflow-hidden"
                ...
                >
                    <Command>
                        ...
                        <Command.List className="max-h-64 overflow-y-auto p-1">
                            <Command.Empty className="px-3 py-4 text-sm text-stone-400 text-center">
                                No results found
                            </Command.Empty>
                            <Command.Item
